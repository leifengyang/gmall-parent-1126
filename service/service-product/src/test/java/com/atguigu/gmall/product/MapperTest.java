...
public class MapperTest {
    ...
    public void testQuery(){
        BaseTrademark byId1 = mapper.selectById(13L);
        System.out.println("第一次"+byId1);

        BaseTrademark byId2 = mapper.selectById(13L);
        System.out.println("第2次"+byId2);


        BaseTrademark byId3 = mapper.selectById(13L);
        System.out.println("第3次"+byId3);

        BaseTrademark byId4 = mapper.selectById(13L);
